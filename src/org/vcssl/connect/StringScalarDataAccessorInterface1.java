 ...
 * <p>
 * <span class="lang-en">
 * An data-I/O interface (abbreviated as String SDAI 1), mainly implemented by data container objects of language processor systems
 * </span>
 * <span class="lang-ja">
...
public interface StringScalarDataAccessorInterface1 {
	...
	/**
	 * <span class="lang-en">The type name of this interface (value: "STRING_SDAI") referred when the plug-in will be loaded</span>
	 * <span class="lang-ja">プラグインのロード時に参照される, このインターフェースの形式名（値: "STRING_SDAI"）です</span>
	 * .
	 */
